    ...
    public static class Injector
    {
        public static void Inject(AssemblyDefinition game, string outputPath)
        {
            ...
            i.Insert(
                     ...
                     p.Create(
                              OpCodes.Call,
                              spaar.ModLoader.Injector.Util.ImportMethod<Assembly>(game, "GetExecutingAssembly")));
            i.Insert(
                     index++,
                     p.Create(
                              OpCodes.Callvirt,
                              spaar.ModLoader.Injector.Util.ImportMethod<Assembly>(game, "get_Location")));
            ...
            i.Insert(
                     ...
                     p.Create(
                              OpCodes.Call,
                              spaar.ModLoader.Injector.Util.ImportMethod<string>(
                                                                                 game,
                                                                                 "Concat",
                                                                                 typeof(string),
                                                                                 typeof(string))));
            i.Insert(
                     ...
                     p.Create(
                              OpCodes.Call,
                              spaar.ModLoader.Injector.Util.ImportMethod<Assembly>(game, "LoadFrom", typeof(string))));
            ...
            i.Insert(
                     ...
                     p.Create(
                              OpCodes.Callvirt,
                              spaar.ModLoader.Injector.Util.ImportMethod<Assembly>(game, "GetType", typeof(string))));
            ...
            i.Insert(
                     ...
                     p.Create(
                              OpCodes.Callvirt,
                              spaar.ModLoader.Injector.Util.ImportMethod<Type>(game, "GetMethod", typeof(string))));
            ...
            i.Insert(
                     ...
                     p.Create(
                              OpCodes.Callvirt,
                              spaar.ModLoader.Injector.Util.ImportMethod<MethodBase>(
                                                                                     game,
                                                                                     "Invoke",
                                                                                     typeof(object),
                                                                                     typeof(object[]))));
